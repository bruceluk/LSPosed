...
-keepclasseswithmembers class com.google.lspd.Main {
    public static void main(java.lang.String[]);
}
-keepclasseswithmembers class com.google.lspd.service.Dex2OatService {
...
-keepclasseswithmembers class com.google.lspd.service.LogcatService {
